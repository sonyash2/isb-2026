...
class AsymmetricCrypto:
    ...
    def generate_key_pair(self):
        """Генерирует пару ключей RSA. Возвращает (private_key, public_key)."""
        try:
    ...
    def encrypt_with_public_key(self, data, public_key):
        """Шифрует данные открытым ключом RSA. Возвращает зашифрованные данные."""
        try:
    ...
    def decrypt_with_private_key(self, encrypted_data, private_key):
        """Расшифровывает данные закрытым ключом RSA. Возвращает расшифрованные данные."""
        try:
    ...
    def serialize_public_key(self, public_key):
        """Сериализует открытый ключ в PEM формат. Возвращает байты."""
        try:
    ...
    def serialize_private_key(self, private_key):
        """Сериализует закрытый ключ в PEM формат. Возвращает байты."""
        try:
    ...
    def deserialize_public_key(self, key_bytes):
        """Десериализует открытый ключ из PEM формата. Возвращает объект ключа."""
        try:
    ...
    def deserialize_private_key(self, key_bytes):
        """Десериализует закрытый ключ из PEM формата. Возвращает объект ключа."""
        try:
